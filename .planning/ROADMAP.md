...
- [x] 22-03-PLAN.md — Settings 前端 RAG Top-K 配置项接入与表单回归测试（KB-RAG-04）
...
- [x] 23-03-PLAN.md — Electron backendChildEnv() 模型 env 注入 + extraResources models/** + D-08 guard（KB-PKG-02）

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 23-04-PLAN.md — 烟测清单文档 docs/smoke-test-23.md + 人工执行验收（KB-PKG-03）
