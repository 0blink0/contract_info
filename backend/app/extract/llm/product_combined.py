...
_PRODUCT_SYSTEM = (
    ...
    "此字段无专项原文，字段摘录可不填）、"
    "海外基金（否/是；合同无「QDII」「境外募集」「跨境」「海外注册」等境外相关表述→默认否；不得留空；此字段为缺省推断，字段摘录可不填）、"
    "母基金代码、产品分类、\n"
    ...
    "可只摘首句或关键句，无需全文；"
    "凡有抽取值的字段均须填写原文（有值必有依据，有依据必有原文）；"
    "仅靠「合同未提及」推断默认值的字段（已在字段说明中注明「字段摘录可不填」者，如结构类型=普通、海外基金=否）可不填。\n\n"
