...
_PRODUCT_SYSTEM = (
    ...
    "份额结构（仅填「不分级」或「分级结构」，禁止输出合同原文描述；合同有A/B/C/D等多类份额→分级结构；无分类→不分级；不得留空）、"
    "结构类型（仅填「普通」或「母子结构」；合同「契约型【开放式】」「合伙型」是组织形式，与此无关；无母子结构→普通）、"
    "海外基金（否/是）、"
    "母基金代码、产品分类、\n"
    "首次申购起点（⚠️只填金额+「万」如「100万」；禁止输出合同原文句子；合同写「不低于100万元人民币」→「100万」）、"
    "追加起点（⚠️只填金额+「万」如「1.0万」；禁止输出合同原文句子；合同写「不低于【1】万元人民币」→「1.0万」；无限制→「无追加起点限制」）、"
    "是否封闭（封闭/不封闭；合同设有封闭期→封闭，无封闭期→不封闭）、封闭方式、封闭期、锁定期、"
